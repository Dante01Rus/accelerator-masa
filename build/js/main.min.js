...
require("./modules/swiper/swiper");
require("./modules/filter/filter");
...
},{"./modules/accordion/init-accordion":3,"./modules/filter/filter":4,"./modules/form-validate/form":6,"./modules/map/map":12,"./modules/menu/menu":13,"./modules/modals/init-modals":15,"./modules/select/custom-select":18,"./modules/swiper/swiper":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";
...
var filterList = document.querySelector('.news__filter-list');
var filterButtons = document.querySelectorAll('.news__filter-btn');
if (filterList) {
  filterList.addEventListener('click', function (evt) {
    if (evt.target.closest('.news__filter-btn')) {
      filterButtons.forEach(function (btn) {
        return btn.classList.remove('news__filter-btn--active');
      });
...
if (map) {
  var _map = L.map('map').setView([55.7753572, 37.6300319], 17);
  var masaIcon = L.icon({
  ...
  var marker = L.marker([55.7753572, 37.6300319], {
    icon: masaIcon
  }).addTo(_map);
  L.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png?{foo}', {
    foo: 'bar'
  }).addTo(_map);
}

},{"../../vendor/leaflet":25}],13:[function(require,module,exports){
"use strict";
...
var modalBtn = document.querySelector('.about__link');
...
},{"./autofocus":14,"./modals":16}],16:[function(require,module,exports){
"use strict";
